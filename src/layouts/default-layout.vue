...
import ModalManager from '@/components/shared/modal-manager.vue'
...
<template>
    <div class="drawer">
        ...
        <div class="drawer-content flex flex-col h-screen">
            ...
            <header
                v-if="!isEditorPage"
                class="flex items-center justify-between p-4 bg-base-100 border-b border-base-300 z-50"
            >
                ...
                <div class="dropdown dropdown-bottom dropdown-end">
                    <button tabindex="0" role="button" class="btn btn-ghost btn-sm" title="Change Theme">
                    ...
                    <ul
                        tabindex="0"
                        class="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-52 text-base-content border border-base-300"
                    >
                        <li>
                            <button type="button" @click="setTheme('auto')" class="flex items-center gap-2">
                        ...
                        <li>
                            <button type="button" @click="setTheme('light')" class="flex items-center gap-2">
                                <Sun class="w-4 h-4" />
                                Light
                        ...
                        <li>
                            <button type="button" @click="setTheme('dark')" class="flex items-center gap-2">
                                <Moon class="w-4 h-4" />
                                Dark
            ...
            <aside class="w-80 min-h-full bg-base-100 text-base-content flex flex-col">
                ...
                <nav class="flex-1 p-4">
                    <ul class="menu">
                        ...
                        <li>
                            <RouterLink to="/templates" class="flex items-center gap-3">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    class="w-5 h-5"
                                    fill="none"
                        ...
                        <li>
                            <RouterLink to="/editor" class="flex items-center gap-3">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    class="w-5 h-5"
                                    fill="none"
